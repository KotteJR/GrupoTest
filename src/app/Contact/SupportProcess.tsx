  ...
  return (
    <section className="w-full bg-white text-[#0f4761] font-sans py-10">
      <div className="max-w-[1230px] mx-auto px-4">
        <h2 className="text-[2rem] font-medium mb-10">Proceso de Soporte Técnico</h2>

        <div className="bg-[#f7f8f9] p-8 rounded-[20px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col items-center">
              ...
              <p className="text-[1rem] leading-snug text-center">{step.label}</p>
            </div>
          ))}
        </div>
      </div>
