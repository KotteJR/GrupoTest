    ...
    <div className="w-full bg-white text-[#0f4761] font-sans py-10">
      <div className="max-w-[1230px] mx-auto px-4">
        ...
        <div className="rounded-[15px] bg-[#f7f8f9] p-8 flex gap-5">
          ...
          Desde el diseño inicial hasta la puesta en marcha final, acompañamos a cada cliente en su proceso de digitalización, garantizando soporte técnico 24/7 y soluciones personalizadas para cada entorno operativo.          </p>
        </div>
        </div>
    </div>
